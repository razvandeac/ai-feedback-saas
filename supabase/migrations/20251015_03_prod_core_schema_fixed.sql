-- =====================================================
-- VAMOOT PRODUCTION CORE SCHEMA MIGRATION (FIXED)
-- Drops all existing policies first, then recreates everything
-- =====================================================
...
-- Helper functions (now safe to drop and recreate)
...
-- RLS Policies (recreate with consistent naming)
do $$ begin
  -- organizations
