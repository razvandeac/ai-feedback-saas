-- Create studio_widgets table (if it doesn't exist)
...
-- Add widget_id foreign key to projects table (if it doesn't exist)
...
DROP POLICY IF EXISTS "studio_widgets_member_select" ON studio_widgets;
DROP POLICY IF EXISTS "studio_widgets_member_insert" ON studio_widgets;
DROP POLICY IF EXISTS "studio_widgets_member_update" ON studio_widgets;
DROP POLICY IF EXISTS "studio_widgets_admin_publish" ON studio_widgets;
